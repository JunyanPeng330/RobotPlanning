...
class MLPActor(nn.Module):  #output Action
...
class MLPQFunction(nn.Module):  #output Q value
...
class MLPActorCritic(nn.Module):
    ...
    def __init__(self, obs_dim, act_dim, act_limit, hidden_sizes=(256,256), activation=nn.ReLU):
        ...
        self.pi = MLPActor(obs_dim, act_dim, hidden_sizes, activation, act_limit)  #policy
        self.q = MLPQFunction(obs_dim, act_dim, hidden_sizes, activation)  #Q value
