...
class APF:
    def __init__(self):
        ...
        #-------------一些参考参数可选择使用-------------#
        self.epsilon0 = 0.8
        self.eta0 = [0.3, 0.2, 0.3, 0.3, 0.3, 0.4, 0.2] # [0.3, 0.3, 0.3, 0.4, 0.2]  [0.3, 0.2, 0.3, 0.3, 0.3, 0.4, 0.2, 0.2]
