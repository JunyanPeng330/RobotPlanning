...
class DDPG:
    def __init__(self, obs_dim, act_dim, act_bound, act_noise, actor_critic=core.MLPActorCritic, seed=0,
                replay_size=int(1e5), gamma=0.98, polyak=0.995, pi_lr=1e-3, q_lr=1e-3):
